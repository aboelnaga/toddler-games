...
/// Registers in-memory platform fakes for audioplayers so AudioPlayer can
/// be instantiated in unit and widget tests without a native host.
void registerAudioFakes() {
