...
STYLE_FRAGMENT = (
    ...
    "flat cream background. The character has an oversized round head, "
    ...
    "gentle inner shading. Reference exemplars: Sago Mini, Hey Duggee, "
    "Toca Boca. Mood: warm, calm, friendly, safe for a 2-year-old. Square "
    "aspect ratio, 2048x2048, centered subject filling about 70% of the "
    "frame, generous negative space around the character. No text, no "
    "decorative lettering, no logos.\n\n"
    "Background: a single pure flat cream #fff5e6 tone — NO watercolor, "
    "NO gradient, NO atmospheric wash, NO peach-to-green sky-and-meadow "
    "blend. The character must appear to float on the flat cream "
    "background. NO baked-in drop shadow beneath the character (shadows "
    "are added programmatically in the app).\n\n"
    ...
    "atmospheric washes, drop shadows under the character.\n\n"
